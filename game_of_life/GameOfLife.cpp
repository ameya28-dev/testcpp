...
#define COLOR_RESET "\033[0m"
    ...
    defined(__MACH__)  // To ensure that we are running on a mondern version of
                       // macOS
#define OS_MAC
...
int main() {
    ...
    string start;
    string filename;
    cout << "                         THE GAME OF life - Implementation in C++"
         << endl;
    cout << endl;
    cout << endl;
    cout << endl;
    cout << "Also known simply as life, " << endl;
    cout << "is a cellular automaton devised by the British mathematician John "
            "Horton Conway in 1970."
         << endl;
    cout << endl;
    cout << "Rules" << endl;
    cout << "The universe of the Game of life is an infinite two-dimensional "
    ...
    cout << "1. Any live cell with fewer than two live neighbours dies, as if "
            "caused by under-population."
         << endl;
    cout << "2. Any live cell with two or three live neighbours lives on to "
            "the next generation."
         << endl;
    cout << "3. Any live cell with more than three live neighbours dies, as if "
            "by over-population."
         << endl;
...
// Tested and working on Ubuntu and Cygwin
    ...
    cout << "\033[2J;" << "\033[1;1H";  // Clears screen and moves cursor to
                                        // home pos on POSIX systems
#endif
}
...
void compareGrid(bool gridOne[gridSize + 1][gridSize + 1],
